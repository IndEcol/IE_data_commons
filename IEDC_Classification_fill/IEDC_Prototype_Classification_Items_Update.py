...
# cur.execute("UPDATE classification_definition SET classification_name = 'cities_regions' WHERE id = 11")    
# cur.execute("UPDATE classification_definition SET classification_name = 'country_subunits' WHERE id = 85")    
# cur.execute("UPDATE classification_definition SET description = 'provinces and other sub-entities of countries' WHERE id = 85")    
# cur.execute("UPDATE classification_definition SET mutually_exclusive = 0 WHERE id = 85")    
# cur.execute("UPDATE classification_definition SET collectively_exhaustive = 0 WHERE id = 85")    
# cur.execute("UPDATE classification_definition SET meaning_attribute1 = 'name of province or other sub-entity' WHERE id = 85")    
# cur.execute("UPDATE classification_definition SET meaning_attribute2 = '2 or 3 letter code for the sub-entity' WHERE id = 85")    
# cur.execute("UPDATE classification_definition SET meaning_attribute5 = 'country' WHERE id = 85")    
# cur.execute("UPDATE classification_definition SET meaning_attribute6 = 'official name of entity (province, prefecture, federal state, …)' WHERE id = 85")    
# cur.execute("UPDATE classification_definition SET meaning_attribute7 = 'year when given list is valid' WHERE id = 85")    
...
cur.execute("UPDATE classification_items SET attribute1_oto = 'Gini index' WHERE attribute1_oto = 'Gini index (SI.POV.GINI)' AND classification_id = 28")
...
# Jan 03, 2026: Expand the China province classification into the country_subunits classification. Manual upload because labels are already defined and used.
# cur.execute("INSERT into classification_items (classification_id, attribute1_oto) VALUES (85,'China, entire country')")
...
# for mnig in range(0,38):
#     cur.execute("INSERT INTO classification_items (classification_id,attribute1_oto,attribute5_anc,attribute6_anc,attribute7_anc) VALUES (%s,%s,%s,%s,%s)",(85,NL1[mnig],'Nigeria',NL2[mnig],2024))
...
# for mchn in range(0,32):
#     cur.execute("UPDATE classification_items SET attribute2_oto = %s, attribute5_anc = %s, attribute6_anc = %s, attribute7_anc = %s WHERE attribute1_oto = %s AND classification_id = 85",(CN2[mchn],'China',CN3[mchn],2024,CN1[mchn]))  
...
# cur.execute("INSERT INTO classification_items (classification_id,attribute1_oto,attribute2_oto,attribute3_oto) VALUES (%s,%s,%s,%s)",(86,'all CE measures','all CE measures','all CE measures'))
...
# cur.execute("UPDATE classification_items SET attribute1_oto = 'EU27 - highly developed', attribute4_oto = 100005, description = 'Belgium, Denmark, Germany, Ireland, Austria, Cyprus, Finland, France, Italy, Netherlands, Spain, and Sweden' WHERE attribute1_oto = 'reserved_24' AND classification_id = 2")
# cur.execute("UPDATE classification_items SET attribute1_oto = 'EU27 - developed', attribute4_oto = 100006, description = 'Croatia, Czech Republic, Estonia, Greece, Hungary, Malta, Poland, Portugal, Slovenia,	Bulgaria, Latvia, Lithuania, Romania, and Slovakia' WHERE attribute1_oto = 'reserved_25' AND classification_id = 2")
# cur.execute("UPDATE classification_items SET attribute1_oto = 'Global, without China', attribute4_oto = 100007, description = 'all countries/regions without China' WHERE attribute1_oto = 'reserved_26' AND classification_id = 2")
# cur.execute("UPDATE classification_items SET attribute1_oto = 'Other European countries', attribute4_oto = 100008 WHERE attribute1_oto = 'reserved_27' AND classification_id = 2")
# cur.execute("UPDATE classification_items SET attribute1_oto = 'Global South', attribute4_oto = 100009 WHERE attribute1_oto = 'reserved_28' AND classification_id = 2")
# cur.execute("UPDATE classification_items SET attribute1_oto = 'Global North', attribute4_oto = 100010 WHERE attribute1_oto = 'reserved_29' AND classification_id = 2")
# cur.execute("UPDATE classification_items SET attribute1_oto = 'Eastern Asia and Pacific', attribute4_oto = 100011 WHERE attribute1_oto = 'reserved_30' AND classification_id = 2")
...
# cur.execute("UPDATE classification_items SET attribute1_oto = 'electricity and natural gas (both as final energy)' WHERE attribute1_oto = 'reserved_31' AND classification_id = 10")  
# cur.execute("UPDATE classification_items SET attribute1_oto = 'all final energy carriers' WHERE attribute1_oto = 'reserved_32' AND classification_id = 10")  
# cur.execute("UPDATE classification_items SET attribute1_oto = 'current provisioning systems and technologies' WHERE attribute1_oto = 'reserved_25' AND classification_id = 8")  
# cur.execute("UPDATE classification_items SET attribute1_oto = 'efficient provisioning systems and technologies' WHERE attribute1_oto = 'reserved_26' AND classification_id = 8")  
# cur.execute("UPDATE classification_items SET attribute1_oto = 'total material requirements (TMR), metal ores' WHERE attribute1_oto = 'reserved_29' AND classification_id = 79")  
# cur.execute("UPDATE classification_items SET attribute1_oto = 'in-use stocks, all materials/products' WHERE attribute1_oto = 'reserved_30' AND classification_id = 79")  
...
# cur.execute("UPDATE classification_items SET attribute1_oto = 'production of pig iron' WHERE attribute1_oto = 'production of pig iron ' AND classification_id = 6")  
# cur.execute("UPDATE classification_items SET attribute1_oto = 'export of pig iron' WHERE attribute1_oto = 'export market for pig iron' AND classification_id = 6")  
# cur.execute("UPDATE classification_items SET attribute1_oto = 'export of direct reduced iron' WHERE attribute1_oto = 'export market for direct reduced iron' AND classification_id = 6")  
# cur.execute("UPDATE classification_items SET attribute1_oto = 'export of ingots and semis' WHERE attribute1_oto = 'export market for ingots and semis' AND classification_id = 6")  
# cur.execute("UPDATE classification_items SET attribute1_oto = 'export of long products' WHERE attribute1_oto = 'export market for long products' AND classification_id = 6")  
# cur.execute("UPDATE classification_items SET attribute1_oto = 'export of final products and commodities' WHERE attribute1_oto = 'export markets for final products and commodities' AND classification_id = 6")  
# cur.execute("UPDATE classification_items SET attribute1_oto = 'export of steel scrap' WHERE attribute1_oto = 'export market for steel scrap' AND classification_id = 6")  
# cur.execute("UPDATE classification_items SET attribute1_oto = 'export of flat products' WHERE attribute1_oto = 'export market for flat products' AND classification_id = 6")  
...
# cur.execute("INSERT into classification_items (classification_id, attribute1_oto) VALUES (100,'PV manufacturing equipment')")
# cur.execute("INSERT into classification_items (classification_id, attribute1_oto) VALUES (14,'2000-2025')")
# cur.execute("INSERT into classification_items (classification_id, attribute1_oto) VALUES (14,'2022-2028')")
# cur.execute("INSERT into classification_items (classification_id, attribute1_oto) VALUES (20,'floorspace, domestic, per capita')")
# cur.execute("INSERT into classification_items (classification_id, attribute1_oto) VALUES (90,'lower layer')")
# cur.execute("INSERT into classification_items (classification_id, attribute1_oto) VALUES (90,'surface layer')")
# cur.execute("INSERT into classification_items (classification_id, attribute1_oto) VALUES (28,'in-use stocks, all materials/products')")
# cur.execute("INSERT into classification_items (classification_id, attribute1_oto) VALUES (6,'markets for final energy, all energy carriers')")
# cur.execute("INSERT into classification_items (classification_id, attribute1_oto) VALUES (6,'lithosphere')")
# cur.execute("INSERT into classification_items (classification_id, attribute1_oto) VALUES (79,'final energy footprint')")
# cur.execute("INSERT into classification_items (classification_id, attribute1_oto) VALUES (28,'household carbon footprint')")
# cur.execute("INSERT into classification_items (classification_id, attribute1_oto) VALUES (4,'quartz')")
...
# cur.execute("INSERT into classification_items (classification_id, attribute1_oto) VALUES (6,'reference flow start')")
# cur.execute("INSERT into classification_items (classification_id, attribute1_oto) VALUES (6,'reference flow end')")
# cur.execute("INSERT into classification_items (classification_id, attribute1_oto) VALUES (7,'reference')")
# cur.execute("INSERT into classification_items (classification_id, attribute1_oto) VALUES (7,'balancing item')")
# cur.execute("INSERT into classification_items (classification_id, attribute1_oto) VALUES (6,'losses')")
...
# 'silver powder',
# 'refined silver',
# 'mined silver (silver in ore)']

# Add2L = ['aggregates and gravel',
# 'chemicals',
# 'finished metals and metal products',
# 'waste, construction, mineralic, non-metallic',
# 'recycled aggregates',
# 'metals, unspecified',
# 'wood wool',
# 'construction materials, unspecified']

# Add2L = ['residential building, informal, standard design',
# 'single-family house, standard design',
# 'multi-family house, standard design',
# 'residential tower, standard design',
# 'mud hut',
# 'mud hut, urban',
# 'mud hut, rural',
# 'apartment building, urban',
# 'apartment building, rural',
# 'bungalow, urban',
# 'bungalow, rural',
# 'bungalow',
# 'compound, urban',
# 'compound, rural',
# 'compound',
# 'informal building, urban',
# 'informal building, rural',
# 'informal building',
# 'unspecified',
# 'concrete building',
...
# 'brick building',
# 'mud building',
# 'concrete-wood building',
# 'residential buildings, semi-detached',
# 'residential buildings, small',
# 'residential buildings, medium',
# 'residential buildings, large',
# 'public buildings, urban',
# 'office buildings, urban',
# 'education buildings, urban',
# 'farm buildings',
# 'government buildings',
# 'non-residential buildings, retail',
# 'non-residential buildings, industrial, meeting area',
# 'non-residential buildings, sport facility',
# 'non-residential buildings, public, meeting area',
# 'non-residential buildings, sport facility, urban',
# 'non-residential buildings, cultural, urban',
# 'healthcare buildings, urban',
# 'restaurants, urban',
# 'commercial complex, urban',
# 'commercial complex, rural']

# Add2L = ['alkaline electrolysis stack',
# 'alkaline electrolysis overall system',
# 'proton exchange membrane stack',
# 'proton exchange membrane overall system',
# 'solid oxide electrolysis overall system',
# 'anion exchange membrane electrolyser overall system',
# 'solid oxide electrolysis stack',
# 'anion exchange membrane electrolyser stack']

# Add2L = ['all components',
# 'rails (railroad)',
# 'railroad ties/sleepers',
# 'railroad track ballast']

# Add2L = ['battery, NCA (nickel–cobalt–aluminium)',
# 'battery, NMC532 (nickel–manganese–cobalt)',
# 'battery, NMC622 (nickel–manganese–cobalt)',
# 'battery, NMC811 (nickel–manganese–cobalt)',
# 'battery, NMC900 (nickel–manganese–cobalt)',
# 'battery, NMC900-Si (nickel–manganese–cobalt)',
# 'battery, LFP (lithium–iron–phosphate)',
# 'battery, SIB (sodium ion battery)',
# 'battery, SSB_poly (solid state battery)',
# 'battery, SSB_ox (solid state battery)',
# 'battery, SSB_sul (solid state battery)',
# 'battery, LSB (lithium/sulfur battery)',
# 'battery, LAB (lithium oxygen/air battery)',
# 'battery, NCA & 100%C (nickel–cobalt–aluminium)',
# 'battery, NMC532 & 100%C (nickel–manganese–cobalt)',
# 'battery, NMC622 & 100%C (nickel–manganese–cobalt)',
# 'battery, NMC811 & 95%C, 5%SiO (nickel–manganese–cobalt)',
# 'battery, NMC900 & 90%C, 10%Si (nickel–manganese–cobalt)',
# 'battery, NMC900 & 100%Si (nickel–manganese–cobalt)',
# 'battery, LFP & 100%C (lithium–iron–phosphate)',
# 'battery, SSB (polymer) (solid state battery)',
# 'battery, SSB (oxidic) (solid state battery)',
# 'battery, SSB (sulfidic) (solid state battery)',
# 'hydrogen',
# 'buildings, all purposes, wooden',
# 'buildings, all purposes, steel frame',
# 'buildings, all purposes, reinforced concrete',
# 'railways, high speed',
# 'railways, high speed (Shinkansen)',
# 'roads',
# 'railways',
# 'roads, interstate rural',
# 'roads, freeways and expressways, rural',
# 'roads, principal arterial rural',
# 'roads, minor arterial, rural',
# 'roads, major collector, rural',
# 'roads, minor collector, rural',
# 'roads, local, rural',
# 'road infrastructure, total, rural',
# 'roads, interstate, urban',
# 'roads, freeways and expressways, urban',
# 'roads, principal arterial, urban',
# 'roads, minor arterial, urban',
# 'roads, major collector, urban',
# 'roads, minor collector, urban',
# 'roads, local, urban',
# 'road infrastructure, total, urban',
# 'road infrastructure, total',
# 'road infrastructure, total',
# 'road, asphalt surface',
# 'roads, stone-paved',
# 'roads, mixed stone and soil',
# 'roads, soil',
# 'roads',
# 'roads, expressway',
# 'roads, class I',
...
# 'water supply pipelines',
# 'pipelines, for steam',
# 'pipelines, for hot water',
# 'sewage pipelines',
# 'street lamps',
# 'cable TV connection, urban',
# 'cable TV connection, rural',
# 'telephone landline connection, urban',
# 'telephone landline connection, rural',
# 'wharf',
# 'roads, main roads',
# 'secondary traffic road',
# 'tertiary traffic road',
...
# 'tunnel, primary road',
# 'secondary traffic road',
# 'bridge, secondary road',
# 'tunnel, secondary road',
# 'tertiary traffic road',
# 'bridge, tertiary road',
# 'tunnel, tertiary road',
# 'roads, local',
# 'bridge, local road',
# 'tunnel, local',
# 'roads, rural',
...
# 'roads, busway',
# 'roads, service road',
# 'roads, tertiary links',
# 'roads, motorway links',
# 'residential building, single-family detached house',
# 'residential building, multi-family house',
# 'residential building, manufactured housing',
# 'residential building, urban',
# 'residential building, rural',
# 'nonresidential building, urban',
# 'nonresidential building, rural',
# 'nonresidential building, commercial',
# 'nonresidential building, industrial',
# 'residential building',
# 'nonresidential building',
# 'nonresidential buildings, hospitals and other health',
# 'nonresidential buildings, hotels and restaurants',
# 'nonresidential buildings, sports and recreation',
# 'nonresidential buildings, shops',
# 'nonresidential buildings, offices, including schools, universities, museums etc.',
# 'nonresidential buildings, service buildings',
# 'residential building, single-family house',
# 'nonresidential building, commercial',
# 'nonresidential buildings, offices',
# 'nonresidential buildings, offices, private sector',
# 'nonresidential buildings, offices, public sector',
# 'nonresidential buildings, hotels and restaurants',
# 'nonresidential buildings, hospitals and other health',
# 'nonresidential buildings, educational buildings',
# 'nonresidential buildings, other',
# 'residential building, detached, rural',
# 'residential building, semi-detached, rural',
# 'residential building, high-rise, rural',
# 'residential building, detached, urban',
# 'residential building, semi-detached, urban',
# 'residential building, apartments, urban',
# 'residential building, high-rise, urban',
# 'nonresidential buildings, offices',
# 'nonresidential buildings, retail',
# 'nonresidential buildings, hotels',
# 'nonresidential buildings, offices, public sector',
# 'nonresidential buildings, other',
# 'residential building, residential towers',
# 'buildings, informal',
# 'residential building, single-family terraced house',
...
# 'stove',
# 'scooter',
# 'nonresidential buildings, public services',
# 'passenger car, internal combustion engine (ICE)',
# 'passenger car, mini, wheelbase ≤ 2450 mm',
# 'passenger car, small, 2450 mm < wheelbase ≤ 2600 mm',
# 'passenger car, medium, 2600 mm < wheelbase ≤ 2750 mm',
# 'passenger car, large, 2750 mm < wheelbase ≤ 2900 mm',
# 'passenger car, executive, 2900 mm < wheelbase',
# 'passenger car, all segments',
# 'recycled aggregates',
# 'aggregates',
# 'waste, construction, mineralic, non-metallic',
# 'nonresidential buildings, hospitals, schools, research buildings',
# 'nonresidential buildings, plants',
# 'road surface layer, express highway',
# 'road surface layer, 1st class highway',
# 'road surface layer, 2nd class highway',
# 'road surface layer, below 2nd class highway',
# 'roads, base layer',
# 'roads, pavement',
# 'roads, upper layer',
# 'rail transit',
# 'BEV-ALL - battery electric vehicle, all battery technologies',
# 'BEV-LFP - battery electric vehicle, lithium iron phosphate battery',
# 'BEV-LMO - battery electric vehicle, lithium manganese oxide battery',
# 'BEV-NCA - battery electric vehicle, nickel-cobalt-aluminum oxide battery',
# 'BEV-NCM-H - battery electric vehicle, high nickel content lithium nickel-cobalt-manganese oxide battery',
# 'BEV-NCM-L - battery electric vehicle, low nickel content lithium nickel-cobalt-manganese oxide battery',
# 'BEV-NCM-M - battery electric vehicle, medium nickel content lithium nickel-cobalt-manganese oxide battery',
# 'PHEV-ALL - plug-in hybrid electric vehicle, all battery technologies',
# 'PHEV-LFP - plug-in hybrid electric vehicle, lithium iron phosphate battery',
# 'PHEV-LMO - plug-in hybrid electric vehicle, lithium manganese oxide battery',
# 'PHEV-NCA - plug-in hybrid electric vehicle, nickel-cobalt-aluminum oxide battery',
# 'PHEV-NCM-H - plug-in hybrid electric vehicle, high nickel content lithium nickel-cobalt-manganese oxide battery',
# 'PHEV-NCM-L - plug-in hybrid electric vehicle, low nickel content lithium nickel-cobalt-manganese oxide battery',
# 'PHEV-NCM-M - plug-in hybrid electric vehicle, medium nickel content lithium nickel-cobalt-manganese oxide battery']

# Add2L = ['final energy footprint, all energy carriers',
# 'final energy footprint, coal and coal products',
# 'final energy footprint, oil products',
# 'final energy footprint, natural gas',
# 'final energy footprint, biofuels and waste',
# 'final energy footprint, non-biomass renewables (geothermal; solar/wind/other)',
# 'final energy footprint, electricity',
# 'final energy footprint, heat',
...
# Add2L = ['raw material input (RMI), biomass',
# 'raw material input (RMI), fossil fuels',
# 'raw material input (RMI), metal ores',
# 'raw material input (RMI), non-metallic minerals',
# 'raw material input (RMI), abiotic materials',
# 'raw material input (RMI), all materials',
# 'total material requirements (TMR), biomass',
# 'total material requirements (TMR), fossil fuels',
# 'total material requirements (TMR), metal ores',
# 'total material requirements (TMR), non-metallic minerals',
# 'total material requirements (TMR), abiotic materials',
# 'total material requirements (TMR), all materials',
# 'land occupation footprint',
# 'water consumption footprint']

# Add2L = ['battery manufacturing - electrode manufacturing (anode) - extruding of lithium foil',
# 'battery manufacturing - electrode manufacturing (anode) - calendering of lithium foil',
# 'battery manufacturing - electrode manufacturing (anode) - passivation',
# 'battery manufacturing - electrode manufacturing (anode) - lamination',
# 'battery manufacturing - electrode manufacturing (anode) - batch mixing',
# 'battery manufacturing - electrode manufacturing (anode) - coating & drying',
# 'battery manufacturing - electrode manufacturing (anode) - calendering',
# 'battery manufacturing - electrode manufacturing (anode) - knife slitting',
# 'battery manufacturing - electrode manufacturing (anode) - vacuum drying',
# 'battery manufacturing - electrolyte manufacturing - batch mixing',
# 'battery manufacturing - electrolyte manufacturing - coating & drying',
# 'battery manufacturing - electrode manufacturing (cathode) - batch mixing',
# 'battery manufacturing - electrode manufacturing (cathode) - coating & drying',
# 'battery manufacturing - electrode manufacturing (cathode) - sintering (T=650°C)',
# 'battery manufacturing - electrode manufacturing (cathode) - calendering',
# 'battery manufacturing - electrode manufacturing (cathode) - knife slitting']

# Add2L = ['battery manufacturing - electrode manufacturing (cathode) - vacuum drying',
# 'battery manufacturing - assembly - cutting (anode)',
# 'battery manufacturing - assembly - cutting (cathode)',
# 'battery manufacturing - assembly - aerosol deposition',
# 'battery manufacturing - assembly - tempering (T=650°C)',
# 'battery manufacturing - assembly - stacking',
# 'battery manufacturing - assembly - welding, packaging, electrolyte filling, closing',
# 'battery manufacturing - assembly - washing',
# 'battery manufacturing - formation & aging - formation',
# 'battery manufacturing - formation & aging - aging',
# 'battery manufacturing - formation & aging - EoL testing',
# 'battery manufacturing - miscellaneous - material handling',
# 'battery manufacturing - miscellaneous - dry rooms (-40°C)',
# 'battery manufacturing - miscellaneous - dry rooms (-60°C)',
# 'battery manufacturing - all processes - aggregate',
# 'use phase - buildings and infrastructure',
# 'use phase - other transport equipment',
# 'use phase - passenger vehicles',
# 'use phase - appliances',
# 'use phase - machinery',
# 'use phase - metal products',
# 'use phase - electric machinery',
# 'market for finished steel',
# 'market for passenger vehicles',
# 'aggregate supply - all sources',
# 'mining - natural sand and gravel',
...
# Add2L = ['material stocks, economy-wide',
# 'material stocks, existing, for providing decent living standards (DLS)',
# 'material stocks, treshold value, for providing decent living standards (DLS) under current practice',
# 'material stock gap, for providing decent living standards (DLS) under current practice',
# 'material stocks, treshold value, for providing decent living standards (DLS) under converged practice']

# Add2L = ['road, asphalt, simple, <5.5 m width',
# 'road, asphalt, high-grade, 5.5 to 13.0m width',
# 'road, asphalt, high-grade, 13.0 to 19.5m width',
# 'road, asphalt, high-grade, more than 19.5m width',
...
# Add2L = ['passenger car, PHEV, lithium ion battery',
# 'passenger car, PHEV, NiMH battery',
# 'passenger car, hybrid electric, lithium ion battery',
# 'passenger car, hybrid electric, NiMH battery',
# 'passenger car, hybrid electric, NiMH battery, with diesel engine']

# Add2L = ['mass, non-metallic minerals',
# 'dry mass, fossil energy carriers',
# 'dry mass, biomass',
# 'mass, metal ores and metals',
# 'dry mass, extractive waste',
# 'dry mass, all materials',
# 'mass, industrial minerals',
# 'mass, construction minerals']

# Add2L = ['waste, from extraction',
# 'metal ores and metals',
# 'recycled materials',
# 'industrial minerals',
# 'construction minerals']

# Add2L = ['all commodities',
# 'raw materials',
# 'solid waste and fuel-related emissions',
...
# 'steel, from basic oxygen furnace (BOF)',
# 'steel, from electric arc furnace (EAF)',
# 'steel ingots and semis',
# 'steel, long products',
# 'steel scrap',
# 'steel, flat products',
# 'final products and commodities',
...
# Add2L = ['domestic supply of resources',
# 'markets, global',
# 'use as energy carrier',
# 'use as material',
# 'waste management and recycling',
# 'markets, processed materials',
# 'atmosphere',
# 'final sinks',
# 'entire economy',
# 'mining',
...
# 'BOF',
# 'EAF',
# 'production of ingots and semis',
# 'production of long products',
# 'production of flat products',
# 'production of final products and commodities',
# 'market for ingots and semis',
# 'markets for final products and commodities',
# 'market for iron ore',
# 'market for pig iron',
# 'market for direct reduced iron',
# 'market for steel scrap',
# 'market for long products',
# 'market for flat products',
# 'use phase',
# 'production of iron ore',
# 'market for iron ore',
# 'final sink',
# 'export market for pig iron',
# 'export market for direct reduced iron',
# 'export market for ingots and semis',
# 'export market for long products',
# 'export market for flat products',
# 'export markets for final products and commodities',
# 'export of iron ore',
# 'export market for steel scrap',
# 'export market for iron ore']

# Add2L = ['all materials',
# 'waste, from extraction',
# 'recycled materials']

# Add2L = ['waste, demolition - buildings, mineralic, non-metallic',
...
# 'recycled aggregates from demolished infrastructure',
# 'recycled aggregates from construction waste',
# 'final energy, all energy carriers']

# Add2L = ['sand and gravel',
# 'crushed stone']
...
# 'concrete',
# 'asphalt',
# 'sand, recycled or recovered',
# 'sand, waste',
# 'gravel',
# 'gravel, waste',
# 'gravel, recycled or recovered']

# Add2L = ['fair inequality',
# 'fair inequality + 1% super-rich',
# 'fairly large inequality',
# 'fair inequality, moderates, 4 < ideal income ratio < 6',
# 'fair inequality, meritocrats, 6 < ideal income ratio',
# 'fair inequality, egalitarians, ideal income ratio < 4',
# 'fairly large inequality, moderates, 4 < ideal income ratio < 6',
# 'fairly large inequality, meritocrats, 6 < ideal income ratio',
# 'fairly large inequality, egalitarians, ideal income ratio < 4']

# Add2L = ['urban built environment',
# 'market for battery and energy storage technologies',
# 'market for photovoltaic (PV) technologies']

# Add2L = ['membrane electrode assemblage',
# 'ductil iron castings',
# 'rotor hub',
# 'permanent magnet',
# 'foundation, fixed-bottom',
# 'foundation, floating',
# 'medium and high voltage subsea cable',
# 'extra high voltage subsea cable',
# 'battery cell',
# 'cathode active material, lithium iron phosphate',
# 'anode active material, graphite',
# 'PV cell',
# 'PV grade polysilicon',
# 'PV grade silicon ingot',
# 'PV wafer',
# 'PV module',
# 'PV inverter',
# 'PV tracker',
...
# Add2L = ['residential floor area',
# 'storage capacity for farmed crops',
# 'Theil index, with population as weighting factor',
# 'Theil index, with GDP as weighting factor',
# 'Share of fraction of population in total indicator',
# 'urban greenspace exposure',
# 'operation/using/handling',
# 'ownership',
# 'thermal comfort exposure',
# 'final energy footprint',
# 'final energy use',
# 'primary energy use, all carriers',
# 'electricity use',
# 'pimary energy footprint, coal',
# 'pimary energy footprint, petroleum',
# 'pimary energy footprint, natural gas',
# 'final energy footprint, hydropower electricity',
# 'final energy footprint, geothermal electricity',
# 'final energy footprint, nuclear electricity',
# 'final energy footprint, charcoal',
# 'final energy footprint, firewood',
# 'final energy footprint, electricity',
# 'final energy footprint, gasoline',
# 'final energy expenditure',
# 'primary energy footprint',
# 'coal and biomass use',
# 'oil and oil products use',
# 'natural gas use']

# Add2L = ['nickel manganese cobalt (NMC), cathode active material',
# 'cathode active material',
# 'nickel, cathode active material',
# 'lithium iron phosphate (LFP), cathode active material',
# 'anode active material',
# 'electrolyte',
# 'separator materials, battery',
# 'polysilicon, PV grade',
# 'polysilicon',
# 'silicon metal',
# 'nickel manganese cobalt (NMC)',
# 'lithium iron phosphate (LFP)']

# Add2L = ['John Cockerill',
# 'Thyssenkrupp',
# 'HydrogenPro',
# 'NEL',
...
# Add2L = ['water supply and wastewater treatment',
# 'communication and information',
# 'electricity supply',
# 'provision of electricity supply infrastructure',
# 'residential floor area']

# Add2L = ['Clahclellah, native American Indian settlement, located in the Columbia River Gorge',
# 'Cathlapotle, native American Indian settlement, located in the Wapato Valley',
# 'Native American Indian settlements, located in the Wapato Valley',
# 'Meier, native American Indian settlement complex, located in the Wapato Valley',
# 'Native American Indian settlements, located along the Lower Columbia River in the Pacific Northwest',
# 'Tete|Mozambique',
# 'Nugaal|Somalia',
# 'Maurentania|Morocco',
# 'NE Botswana|Botswana',
# 'E Zimbabwe|Zimbabwe',
# 'N Zimbabwe|Zimbabwe',
# 'S Zimbabwe|Zimbabwe',
# 'Shaanxi|China',
...
# 'Baden-Wurttemberg Mineral|Germany',
# 'Baden-Wurttemberg Wetland|Germany',
# 'Bavaria|Germany',
# 'Hessia|Germany',
...
# 'Bydgoszcz|Poland',
# 'Luzern|Switzerland',
# 'Pays des Trois-Lacs|Switzerland',
# 'Solothurn|Switzerland',
# 'Vaud|Switzerland',
# 'Zurich|Switzerland',
# 'Dneister-Bug|Moldova',
# 'Prut-Dneister|Romania',
# 'Siret-Prut|Romania',
# 'Southern Bug-Dnieper|Ukraine',
# 'Cambridgeshire|Great Britain',
# 'Bedfordshire|Great Britain',
# 'Buckinghamshire|Great Britain',
# 'Glamorgan-Gwent|Great Britain',
...
# 'Clwyd-Powys|Upland Wales and the Marches',
# 'Dyfed|Upland Wales and the Marches',
# 'Gwynedd|Upland Wales and the Marches',
# 'Visoko Basin|Bosnia and Herzegovina',
# 'N Bulgaria|Bulgaria',
# 'S Bulgaria|Bulgaria',
# 'Andros|Greece',
# 'Argolid|Greece',
...
# 'Central Romania',
# 'S Romania',
# 'S Carpathian Basin|Serbia',
# 'N Switzerland',
# 'W Switzerland',
# 'Chalco|Central Mexico',
# 'Cuitlahuac|Central Mexico',
# 'Mixquic|Central Mexico',
# 'Tenanco|Central Mexico',
# 'Cuautitlan|Central Mexico',
# 'Ecatepec|Central Mexico',
# 'Guadalupe|Central Mexico',
# 'Tenochtitlan-Tlatelolco|Central Mexico',
# 'Ixtapalapan|Central Mexico',
# 'Ixtapalucan|Central Mexico',
# 'Morelos|Central Mexico',
# 'Tlaxcala|Central Mexico',
# 'Chiconautlan|Central Mexico',
# 'Otumba|Central Mexico',
# 'Santa Paula|Central Mexico',
# 'Teotihuacan Valley|Central Mexico',
# 'Tepexpan|Central Mexico',
# 'Tezoyucan|Central Mexico',
# 'Chiautlan|Central Mexico',
# 'Tepetlaoztoc|Central Mexico',
# 'Texcoco|Central Mexico',
# 'Toltec Texcoco|Central Mexico',
# 'Tuexotla|Central Mexico',
# 'Culhuacan|Central Mexico',
# 'Xochimilco|Central Mexico',
# 'Apaxco|Central Mexico',
# 'Toltec Zumpango|Central Mexico',
# 'Zumpango|Central Mexico',
# 'Central Belize|Maya',
# 'Coastal Plains|Maya',
# 'Highlands|Maya',
# 'Plains|Maya',
...
# 'Central Peten|Maya',
# 'Eastern Peten|Maya',
# 'Southern Foothills|Maya',
# 'Chiapas|Maya',
# 'Usumacinta|Maya',
# 'Central|Valley of Oaxaca|Southern Mexico',
# 'Tlacolula|Valley of Oaxaca|Southern Mexico',
...
# 'SW|Wyoming',
# 'NA|Wyoming',
# 'Mohawk|Haudenosaunee|Northeast North America',
# 'Onondaga|Haudenosaunee|Northeast North America',
# 'Southwest Ontario|Neutral|Northeast North America',
# 'Huronia|Wendat|Northeast North America',
# 'North Shore of Lake Ontario|Wendat|Northeast North America',
# 'Trent Valley|Wendat|Northeast North America',
# 'Kodiak|North Pacific|Northwest North America',
# 'Columbia|Northwest Coast|Northwest North America',
# 'Queen Charlottes|Northwest Coast|Northwest North America',
# 'Skeena|Northwest Coast|Northwest North America',
# 'Vancouver|Northwest Coast|Northwest North America',
# 'Blue Ridge|Deep South|Southeast North America',
# 'Interior Low Plateau|Deep South|Southeast North America',
# 'Piedmont|Deep South|Southeast North America',
# 'Ridge and Valley|Deep South|Southeast North America',
# 'Southeastern Floodplains|Deep South|Southeast North America',
# 'American Bottom|Midwest|Southeast North America',
# 'Interior Plateau|Midwest|Southeast North America',
# 'Hia-Ced|Desert SW|Southwest North America',
# 'Lower Gila|Desert SW|Southwest North America',
# 'Phoenix Basin|Desert SW|Southwest North America',
# 'Tonto Basin|Desert SW|Southwest North America',
# 'Tucson Basin|Desert SW|Southwest North America',
# '|Northern Periphery|Southwest North America',
# 'Great Salt Lake|Northern Periphery|Southwest North America',
# 'Parowan|Northern Periphery|Southwest North America',
# 'San Rafael|Northern Periphery|Southwest North America',
# 'Sevier|Northern Periphery|Southwest North America',
# 'Uinta|Northern Periphery|Southwest North America',
# 'Chaco|Upland SW|Southwest North America',
# 'Chinle Valley|Upland SW|Southwest North America',
# 'Chuska Valley|Upland SW|Southwest North America',
# 'Dolores|Upland SW|Southwest North America',
# 'Hopi Mesas|Upland SW|Southwest North America',
# 'Hovenweep|Upland SW|Southwest North America',
# 'Lower San Juan|Upland SW|Southwest North America',
# 'McElmo|Upland SW|Southwest North America',
# 'Mesa Verde NP|Upland SW|Southwest North America',
# 'Middle San Juan|Upland SW|Southwest North America',
# 'N. Chuska|Upland SW|Southwest North America',
# 'Rio Puerco East|Upland SW|Southwest North America',
# 'S. Chuska|Upland SW|Southwest North America',
# 'Upper San Juan|Upland SW|Southwest North America',
# 'Middle Sepik|New Guinea',
# 'Papuan Plateau|New Guinea',
# 'Sepik|New Guinea',
# 'Hana District, Maui|Hawaiian Islands',
# 'Honuaula District, Maui|Hawaiian Islands',
# 'North Kona District, Hawaii Island|Hawaiian Islands',
# 'South Kohala District, Hawaii Island|Hawaiian Islands',
# 'South Kona District, Hawaii Island|Hawaiian Islands',
# 'Coromandel, Ahuahu Island|New Zealand',
# 'Northland, North Island|New Zealand',
# 'Tamaki, North Island|New Zealand',
# 'Tamaki, Ponui Island|New Zealand',
# 'Rapa Nui|Polynesia',
# 'Lambayeque Valley|North Coast of Peru',
# 'Moche Valley|North Coast of Peru',
# 'Santa Valley|North Coast of Peru',
# 'Supe|North Coast of Peru',
# 'Cusco|Peruvian Highlands',
# 'Huanuco|Peruvian Highlands',
# 'Junin|Peruvian Highlands',
# 'Canete Valley|South Coast of Peru',
# 'Nasca|South Coast of Peru',
# 'Curahuara|Carangas|Southern Andes',
# 'Sajama|Carangas|Southern Andes',
# 'San Antonio|Lipez|Southern Andes',
# 'Putre|Northern Chile',
# 'Jujuy|NW-Argentina',
# 'Salta|NW-Argentina',
# 'Tucuman|NW-Argentina',
# 'Moquegua|Osmore|Southern Andes',
# 'Potosí|Southern Andes',
# 'Intersalar|Southern Altiplano|Southern Andes',
# 'Titicaca|Southern Altiplano|Southern Andes']

# Add2L = ['quartz for silicon metal production',
# 'refined silver',
# 'silver-containing ores',
# 'silicon metal',
# 'cobalt-containing ores',
# 'manganese-containing ores',
# 'nickel containing ores',
# 'lithium-containing ores and clays',
# 'all goods and services',
# 'vehicle fuel, vehicle operation, and maintenance',
# 'land transport',
# 'air transport',
# 'water transport',
# 'education material and services, financial services',
# 'food',
# 'alcohol and tobacco',
# 'wearables/clothing',
...
# 'vehicle purchase',
# 'restaurants, hotels, luxury items',
# 'other transport services',
# 'communication',
# 'recreational items',
# 'package holidays',
# 'education material and services, financial services, luxury items',
# 'residential building, house segments',
# 'residential building',
# 'storage building',
# 'residential building, including storage space',
# 'housing and housing services',
# 'transport',
# 'education material and services',
# 'other goods and services purchased by households',
# 'housing',
# 'other goods and services purchased by households',
# 'household facilities',
# 'primary health care institutions',
# 'hospitals, measured as hospital beds',
# 'doctor office, physician',
# 'urban green and blue spaces',
# 'building heating and cooling devices',
# 'buildings, office',
# 'buildings, shopping mall',
# 'buildings, hotel',
# 'battery, LIB (lithium-ion battery)',
# 'silver paste',
# 'silver powder',
# 'electrolyzers, alkaline (AEL)',
# 'electrolyzers, proton exchange membrane (PEMEL)',
# 'electrolyzers, anion exchange membrane (AEMEL)',
# 'electrolyzers, solid-oxide (SOEL)',
# 'wind turbines, onshore and offshore',
# 'batteries',
# 'photovoltaic (PV) modules',
# 'photovoltaic (PV) cells, solar cells',
# 'photovoltaic (PV) installation',
# 'photovoltaic (PV) modules, with tunnel oxide passivated contact solar cells (TOPCon)',
# 'photovoltaic (PV) modules, with silicon heterojunction solar cells (SHJ)',
# 'nickel manganese cobalt (NMC), cathode active material',
# 'lithium iron phosphate (LFP), cathode active material',
# 'polysilicon, PV grade',
# 'silver-containing ores']

# Add2L = ['ca. 1650 to 1950',
# 'ca. 700 to 1800',
# 'ca. 100 to 299',
# 'ca. 1970 to 1970',
# 'ca. 1300 to 1650',
...
# Add2L = ['all final energy carriers',
...
# Add2L = ['access to healthcare services',
# 'material footprint, all materials',
# 'material footprint, biomass',
# 'material footprint, fossil fuels',
# 'material footprint, metals',
# 'material footprint, non-metallic minerals',
# 'domestic water use',
# 'water use, registered']

# Add2L = ['all final goods and services consumed by households',
# 'drinking water',
# 'water',
# 'agricultural land']

# Add2L = ['Yellow River Basin, China',
# 'Olifants River Water Management Area, South Africa']

# Add2L = ['households and other final consumers',
# 'households, urban']

# Add2L = ['final energy carriers, delivered to households and other final consumers',
# 'vehicle fuel and operation']

# Add2L = ['heating system, underfloor',
# 'maintenance',
# 'heat pump',
...
# Add2L = ['all materials (aggregate)',
# 'construction minerals, related materials and waste']

# Add2L = ['import markets, global',
# 'export markets, global',
# 'final sinks, emissions',
# 'final sinks, waste']

# Add2L = ['raw materials, biomass fraction',
...
# 'solid and liquid waste, metal ores and metals fraction',
# 'solid waste and fuel-related emissions, metal ores and metals fraction',
# 'all materials, metal ores and metals fraction',
# 'solid and liquid waste, biomass fraction',
# 'solid waste and fuel-related emissions, biomass fraction',
# 'all materials, biomass fraction',
# 'raw materials, non-metallic minerals fraction',
# 'all commodities, non-metallic minerals fraction',
# 'solid and liquid waste, non-metallic minerals fraction',
# 'solid waste, non-metallic minerals fraction',
# 'fuel-related emissions, non-metallic minerals fraction',
# 'solid waste and fuel-related emissions, non-metallic minerals fraction',
# 'all materials, non-metallic minerals fraction',
# 'recycled materials, non-metallic minerals fraction',
# 'solid and liquid waste, fossil fuel fraction',
# 'solid waste and fuel-related emissions, fossil fuel fraction',
# 'all materials, fossil fuel fraction',
# 'solid waste and fuel-related emissions',
# 'sand, in concrete',
# 'sand, in asphalt',
# 'sand, recycled or recovered',
...
# Add2L = ['import of ingots and semis',
# 'import of final products and commodities',
# 'import of iron ore',
# 'import of pig iron',
# 'import of direct reduced iron',
# 'import of steel scrap',
# 'import of long products',
# 'import of flat products']

# Add2L = ['Oskarshamn nuclear plant',
# 'Grimstad Renewable Energy Park',
# 'HARI project, West Beacon Farm',
# 'PURE Project, Unst',
# 'Baglan Energy Park Wales',
# 'Regenerativer Energipark Ostfalia/hybrid renewable energy park (HREP)',
# 'H2KT - Hydrogen Energy Storage in NuUnited Kingdom',
# 'Djeva',
# 'Hamburg Hafen City, CEP',
# 'Hybrid Power Plant Enertrag, Prenzlau',
# 'EnBW H2 station, Stuttgart',
# 'DNV Kema/DNV GL',
# 'H2Herten',
# 'H2 research center BTU Cottbus',
# 'Cotbus',
# 'Hydrogen mini grid system Yorkshire (Rotherham)',
# 'P2G plant Erdgas Schwaben',
# 'MicrobEnergy GmbH, Schwandorf',
# 'H2Move, Fraunhofer ISE',
# 'ETOGAS, Solar Fuel Beta-plant AUDI, Werlte (Audi e-gas)',
# 'WindGas Falkenhagen',
# 'H2 Logic HRS with onsite electrolysis Aalborg',
# 'H2 Logic HRS with onsite electrolysis in Vejle',
# 'H2 Logic HRS with onsite electrolysis Holstebro',
# 'H2 Logic 3 HRS with onsite electrolysis in Copenhagen',
# 'Oslo, CHIC',
# 'Hanau, Wolfgang Industrial Park',
# 'H2BER (Berlin airport)',
# 'Hydrogen Valley South Tyrol - Bolzano, CHIC',
# 'Woikoski Kokkola H2 plant',
# 'Stromlückenfüller 1st phase',
# 'RH2 Grapzow, Mecklenburg Vorpommern',
# 'P2G-Biocat - Continued (Ref 508)',
# 'Don Quichote',
# 'HRS CNH2 Puertollano',
# 'Hassfurt',
# 'HPEM2GAS (R&D)',
# 'Hamburg - Schnackenburgallee',
# 'Laboratory System at IFE Kjeller Pahse 2',
# 'Hydrogen plant - Orkney Islands - BIG HIT 1st phase',
# 'Energy observer',
# 'H&R Ölwerke Hamburg-Neuhof',
# 'Alzey, Exytron Null-E',
# 'Energiepark Mainz',
# 'FaHyence',
# 'HySnowGroomer (within HyWest)',
# 'ASKO Midt-Norge',
# 'Aberdeen Conference Center',
# 'Underground Sun Conversion',
# 'Troia,  STORE&GO',
# 'GNVert H2 ',
# 'CoSin: Synthetic Natural Gas from Sewage, Barcelona',
# 'REFLEX',
# 'Rostock, Exytron Demonstrationsanlage',
# 'Falkenhagen STORE&GO',
# 'Windgas Haurup, 1st phase',
# 'Methanation at Eichhof',
# 'Minatecs semiconductor labs in Grenoble',
# 'Hydrogen plant - Orkney Islands - BIG HIT 2n phase',
# 'H2FUTURE',
# 'Parnu refuelling station',
# 'H2Nodes, Riga',
# 'Houdain bus station HRS (TADAO/Bulle 6 SMTAG)',
# 'Vårgårda Bostäder housing complex',
# 'Stromlückenfüller 2nd phase',
# 'Wind to Gas Südermarsch',
# 'Solothurn, STORE&GO',
# 'HyDeploy',
# 'HyBALANCE',
# 'Wyhlen hydroelectric power plant',
# 'GrInHy2.0',
# 'Leuchtturmprojekt Power-to-Gas Baden-Württemberg',
# 'eFarm (5 production sites in North Frisia)',
# 'Windgas Haurup, 2nd phase',
# 'H2ORIZON',
# 'Wuppertal refuelling station',
# 'HRS Aalborg',
# 'Hotflex',
# 'Hydrospider - St Gallen',
# 'HYBRIT pilot',
# 'Fébus Pau bus station HRS',
# 'H2APEX Energy, Rostock-Laage',
# 'HRS CMB Port of Antwerp',
# 'Tyseley Energy Park refuelling hub Birmingham',
# 'Refhyne',
# 'Vallée Hydrogène Grand Ouest (VHyGO) - H2 Ouest (Phase 1)',
# 'SALCOS - WindH2 Windwasserstoff Salzgitter',
# 'AuxHYGen (Phase 1)',
# 'Fairfuel Atmosfair',
# 'Green Hydrogen Esslingen (P2G2P)',
# 'Hydrogen Lab Leuna (phase 1)',
# 'HAEOLUS',
# 'Iberdrola - Puertollano I',
# 'Green Hysland Mallorca - Phase 1',
# 'H2RES - Orsted offshore wind',
# 'MPREIS Hydrogen (within Demo4Grid)',
# 'Alliander Oosterwolde - solar park of GroenLeven',
# 'HRS TMB Zona Franca de Barcelona',
# 'Hysolar Green on Road - Nieuwegein',
# 'H2-Login',
# 'Wunsiedel Energy Park (Phase 1)',
# 'HRS Bremervörde - trains',
# 'Fronius Solhub - SAN Group Herzogenburg',
# 'PtG Switzerland',
# 'Heroya Industrial Park',
# 'REMOTE - Spain, Canary Islands',
# 'Multiphly',
# 'Hyport - Toulouse-Blagnac Airport',
# 'Zero Emission Valley (ZEV) - Clermont Ferrand',
# 'Abanto Technology Park',
# 'Aquamarine',
# 'H2Pioneer - H2 Carinthia',
# 'Hydrogen Lab Bremerhaven (phase 1)',
# 'H2 project - AEM Flex electrolyser',
# 'Picea systems installed at multiple residential households (500 2.4 kW)',
# 'Hofors rolling project',
# 'H2 Évora - GreenGas II',
# 'NFC Belfort (Phase 1)',
# 'Val d Hygo (Occitanie H2 Corridor)',
# 'Vätgas Ljungby',
# 'Porte de St Cloud HRS station',
# 'Renewable Gasfield',
# 'Undergorund Sun Storage 2030',
# 'Turn2X - Extremadura',
# 'Energy-Norweigian Catapult Centre',
# 'Gaznat methanation project',
# 'H100 Fife Project, Levenmouth',
# 'REDDAP - REnewable Distributed & Dynamic Ammonia Plant',
# 'Konin Power Plant, phase 1 - ZE PAK',
# 'H2 Pilotanlage Lingen, phase 1',
# 'Octopus Hydrogen - MIRA Technology Park',
# 'HYBAYERN',
# 'European Energy, phase I',
# 'Trailblazer - Siemens-Air Liquide Oberhausen, Phase 1',
# 'Szazhalombatta refinery',
# 'Dijon Métropole Smart EnergHy (DMSE) - Station 1',
# 'Factory 01',
# 'Vallée Hydrogène Grand Ouest (VHyGO) - H2 Ouest (Phase 2)',
# 'Flins Plant - HYVIA',
# 'H2 Pilotanlage Lingen, phase 2',
# 'BÜKKABRÁNY PtG',
# 'Wien Energie -  Simmering',
# 'Hy2B plant in Pfeffenhausen',
# 'InnovaHub',
# 'Ardagh Glass Limmared AB - Hydrogen plant',
# 'Green fertilizer project Porsgrunn-Heroya, phase 1 - SKREI',
# 'Glencore Nikkelverk HCl plant',
# 'Norwegian Hydrogen, Hellesylt Hydrogen Hub 1st project',
# 'HySynergy, phase 1',
# 'UpHy, phase 1',
# 'P2X Harjavalta project',
# 'Port of Aabenraa, Kasso Power-to-X facility',
# 'NFC Belfort (Phase 2)',
# 'Hydrogen plant - Environmental Business Park (PEMA)',
# 'Hy4Chem - BASF Ludwigshafen',
# 'Hunfeld project ',
# 'AEM Nexus for Unigranit',
# 'HY.City.Bremerhaven',
# 'Green hydrogen for fragrance industry']
