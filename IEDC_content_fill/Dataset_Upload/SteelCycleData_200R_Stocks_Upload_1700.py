...
# Get dataset lists:
StockFileList    = ['S_12_D_1700']  
StockDataSetList = ['2_IUS_steel_200R_pre_1900']
StockMatlList    = ['all steel-containing products']
...
for ds in range(0,len(StockFileList)):
    ...
    for line in lines:
    	...
    	# match labels to classification_items entry
            ...
            # Add data into db:
            if StockValue > 0: #only nonzero values are reported
