...
# Get dataset lists:
FlowFileList    = ['F_11_12_4Cats_Refined']
 
FlowDataSetList = ['1_F_steel_200R_F_11_12_final_steel_consumption_4ProductGroups']
...
for ds in range(0,len(FlowFileList)):
    ...
    # 7 Classifications are used, get their items:
