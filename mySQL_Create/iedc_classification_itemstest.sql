...
--
-- Table structure for table `classification_itemstest`
--

DROP TABLE IF EXISTS `classification_itemstest`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `classification_itemstest` (
  ...
  `attribute2_oto` varchar(255) DEFAULT NULL,
