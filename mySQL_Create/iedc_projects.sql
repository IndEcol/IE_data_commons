...
CREATE TABLE `projects` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `UC_projects` (`project_name`),
  KEY `project_license_id` (`project_license`),
  KEY `project_sources_id` (`type_of_source`),
  KEY `project_users_id` (`submitting_user`),
  CONSTRAINT `project_license_id` FOREIGN KEY (`project_license`) REFERENCES `licences` (`id`),
  CONSTRAINT `project_sources_id` FOREIGN KEY (`type_of_source`) REFERENCES `source_type` (`id`),
  CONSTRAINT `project_users_id` FOREIGN KEY (`submitting_user`) REFERENCES `users` (`id`)
