<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="uncertainty.aspx.cs" Inherits="IEF_Database.uncertainty" %>
    ...
    <div class="row">
     ...
     <div class="row">
           ...
           <div class= "col-md-12"  style="background-color:#b3ffcc">
              ...
              <h4>Table contents of Stats Array </h4>
              
               <asp:GridView ID="grdStatsArray" runat="server" CellPadding="10" ForeColor="#333333" BorderColor="#E3EAEB" BorderStyle="None" BorderWidth="1px" Width="100%" >
