<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="aspects.aspx.cs" Inherits="IEF_Database.aspects" %>
...
<div class="container-fluid" >
     ...
     <div class="row">
           <div class= "col-md-12"  style="background-color:#b3ffcc">
               <div style=" width:100%; overflow:scroll;">
                   <h4>Table contents of Aspect </h4>

              <asp:GridView ID="grdAspect" runat="server" CellPadding="10" ForeColor="#333333" BorderColor="#E3EAEB" BorderStyle="None" BorderWidth="1px" Width="100%" >
    ...
    <div class="row">
              <div class= "col-md-12"  style="background-color:#b3ffcc">
                  <h4>Table contents of Dimensions </h4>
                <asp:GridView ID="grdDimensions" runat="server" CellPadding="10" ForeColor="#333333" BorderColor="#E3EAEB" BorderStyle="None" BorderWidth="1px" Width="100%" >
                  <HeaderStyle Height="40px" BackColor="#1C5E55" ForeColor="White" />
                                                <AlternatingRowStyle BackColor="White" />
                  <EditRowStyle BackColor="#7C6F57" />
                                                <FooterStyle BackColor="#1C5E55" Font-Bold="True" ForeColor="White" />
