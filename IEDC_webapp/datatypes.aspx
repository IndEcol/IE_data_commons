<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="datatypes.aspx.cs" Inherits="IEF_Database.datatypes" %>
...
<div class="container-fluid" >
    ...
    <div class="row">
     ...
     <div class="row">
           <div class= "col-md-12"  style="background-color:#b3ffcc">
                <h4>Table contents of Categories </h4>
              <asp:GridView ID="grdCategories" runat="server" CellPadding="10" ForeColor="#333333" BorderColor="#E3EAEB" BorderStyle="None" BorderWidth="1px" Width="100%" >
    ...
    <div class="row">
     ...
     <div class="row">
               <div class= "col-md-12"  style="background-color:#b3ffcc">
                    <h4>Table contents of Types </h4>
              <asp:GridView ID="grdTypes" runat="server" CellPadding="10" ForeColor="#333333" BorderColor="#E3EAEB" BorderStyle="None" BorderWidth="1px"  Width="100%">
                  <HeaderStyle Height="40px" BackColor="#1C5E55" ForeColor="White" />
                                                <AlternatingRowStyle BackColor="White" />
                  <EditRowStyle BackColor="#7C6F57" />
                                                <FooterStyle BackColor="#1C5E55" Font-Bold="True" ForeColor="White" />
    ...
    <div class="row">
     ...
     <div class="row">
               <div class= "col-md-12"  style="background-color:#b3ffcc">
                    <h4>Table contents of Layers </h4>
              <asp:GridView ID="grdLayers" runat="server" CellPadding="10" ForeColor="#333333" BorderColor="#E3EAEB" BorderStyle="None" BorderWidth="1px" Width="100%" >
                  <HeaderStyle Height="40px" BackColor="#1C5E55" ForeColor="White" />
                                                <AlternatingRowStyle BackColor="White" />
                  <EditRowStyle BackColor="#7C6F57" />
                                                <FooterStyle BackColor="#1C5E55" Font-Bold="True" ForeColor="White" />
