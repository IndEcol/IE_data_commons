<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="classifications.aspx.cs" Inherits="IEF_Database.classifications" %>
     ...
     <div class="row">
           <div class= "col-md-12"  style="background-color:#b3ffcc">
               <div style=" width:100%; overflow:scroll;">
                    ...
                    <h4>Table contents of Classifications </h4>
              <asp:GridView ID="grdClassifications" runat="server" CellPadding="10" ForeColor="#333333" BorderColor="#E3EAEB" BorderStyle="None" BorderWidth="1px" Width="100%" AllowPaging="True" OnPageIndexChanging="grdClassifications_PageIndexChanging" PageSize="100"  >
                  <HeaderStyle Height="40px" BackColor="#1C5E55" ForeColor="White" />
                                                <AlternatingRowStyle BackColor="White" />
                  <EditRowStyle BackColor="#7C6F57" />
                                                <FooterStyle BackColor="#1C5E55" Font-Bold="True" ForeColor="White" />
                                                <HeaderStyle BackColor="#1C5E55" Font-Bold="True" ForeColor="White" />
                                                <PagerStyle BackColor="#666666" ForeColor="White" HorizontalAlign="Center" BorderStyle="Solid" BorderWidth="2px" Width="10%" />
    ...
    <div class="row">
         <br />
           <div class= "col-md-12"  style="background-color:#b3ffcc">
                   ...
                   <tr>
                       <td align="right">Select Classification Item: </td>
                       <td> <asp:DropDownList ID="drpClassifications" runat="server" AutoPostBack="True" OnSelectedIndexChanged="drpClassifications_SelectedIndexChanged" class="form-control" style="width:30%"></asp:DropDownList></td>
                   </tr>
               </table>
    ...
    <div class="row">
           ...
           <div class= "col-md-12"  style="background-color:#b3ffcc">
              <div style=" width:100%; overflow:scroll;">
                   ...
                   <h4>Table contents of Selected Classification Item </h4>


              <asp:GridView ID="grdClassificationItems" runat="server" CellPadding="10" ForeColor="#333333" BorderColor="#E3EAEB" BorderStyle="None" BorderWidth="1px" Width="100%" AllowPaging="True" OnPageIndexChanging="grdClassificationItems_PageIndexChanging" PageSize="100" >
                  <HeaderStyle Height="40px" BackColor="#1C5E55" ForeColor="White" />
                                                <AlternatingRowStyle BackColor="White" />
                  <EditRowStyle BackColor="#7C6F57" />
                                                <FooterStyle BackColor="#1C5E55" Font-Bold="True" ForeColor="White" />
