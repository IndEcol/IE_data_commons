...
{
    public partial class frmDatabaseHome : System.Web.UI.Page
    {
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            //{
            //    string param = "";
            //    if (hdnSelectedYear.Value != "")
            //    {
            //        param = "stocks.time in (" + hdnSelectedYear.Value + ")";
            //    }

            //    string paramss = "stocks.time in (" + hdnSelectedCountry.Value + ")";

            //    ds = clsD.stocksDataSet(Convert.ToString(drdStocks.SelectedValue), param);
            //}
